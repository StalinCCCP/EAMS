...
<template>
    <n-form>
      <n-form-item label="SoftwareID">
        <n-input :disabled="!isadmin" v-model:value="SoftwareID" type="text" placeholder="Input Software Name" />
      </n-form-item>
      ...
      <n-form-item label="Cost">
        <n-input :disabled="!isadmin" v-model:value="Cost" type="text" placeholder="Input Software Name" />
      </n-form-item>
      <n-form-item label="MaintenanceDate">
        <n-input :disabled="!isadmin" v-model:value="MaintenanceDate" type="text" placeholder="Input Software Name" />
      </n-form-item>
    ...
    http
      ...
      .then((r) => {
        if (r.status === 200) {
          ...
          SoftwareID.value=data.value.SoftwareID
  ...
  const post= () => {
    data.value.SoftwareID=SoftwareID.value
