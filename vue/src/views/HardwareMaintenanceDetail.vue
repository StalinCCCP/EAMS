<template>
    <n-form>
      <n-form-item label="HardwareID">
        <n-input :disabled="!isadmin" v-model:value="HardwareID" type="text" placeholder="Input Hardware Name" />
      </n-form-item>
      ...
      <n-form-item label="Cost">
        <n-input :disabled="!isadmin" v-model:value="Cost" type="text" placeholder="Input Hardware Name" />
      </n-form-item>
      <n-form-item label="MaintenanceDate">
        <n-input :disabled="!isadmin" v-model:value="MaintenanceDate" type="text" placeholder="Input Hardware Name" />
      </n-form-item>
  ...
  import {ref} from 'vue'
  import createColumns from '@/models/HardwareMaintenanceDetailTable';
    ...
    http
      ...
      .then((r) => {
        if (r.status === 200) {
          ...
          HardwareID.value=data.value.HardwareID
  ...
  const post= () => {
    data.value.HardwareID=HardwareID.value
